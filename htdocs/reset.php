...
use PHPMailer\PHPMailer\Exception;
    ...
    $mail->SetFrom("rentwebhost@gmail.com");
    $mail->isHTML(true);
    $mail->Body ="<h1>Welcome To Rentweb</h1><br>Confirm your email by using following OTP to reset your password.<br><h2>Your OTP Verification code is ".$otp."</h2><br><h5>Have a nice day<br>Rentweb<h5/>";
