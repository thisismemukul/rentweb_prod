            ...
            <div class="row">
                ...
                <div style="left: 8%;" class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <ul>
                                <li><a href="https://www.instagram.com/walker._.12" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                <li><a href="https://www.twitter.com/thisisme_mukul" target="_blank"><i class="fa fa-twitter"></a></i></li>
                            </ul>
                            <h5><a href="https://www.instagram.com/walker._.12" target="_blank">Mukul Saini</a></h5>
                            <h6>CEO</h6>
