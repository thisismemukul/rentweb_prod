...
<head>
    ...
    <title>Product Details | Rentweb</title>
                ...
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        $row_username = mysqli_fetch_array($results);
                                    ...
                                    $available = $row_username['avalable'];
                            ?>  
                          <img class="img-fluid" height="600" width="600" src="<?php echo $imageURL;  ?>" alt="product_image" /><br>
                            ...
                            if($available == 'Y'){ 
                            ?>
                            <form action="useritems.php" method="post">
                            <!-- <a href="checkout.php"><button class="btn btn-secondary">Proceed</button></a> -->
                            <button type="submit" name="proceed" class="btn btn-secondary">Proceed</button>
                            </form>
                            <?php 
                            }else{ ?>
                            ...
                            <?php } ?> 
                            <br>
                            <a><input class="btn btn-secondary" action="action" onclick="window.history.go(-1); return false;" type="submit" value="Back"/></a>
