...
<head>
    ...
    <title>Appliances | Rentweb</title>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="https://image.freepik.com/free-vector/3d-realistic-mock-up-with-gray-two-chambered-refrigerator-isolated-tile-wall_1441-2146.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="https://image.freepik.com/free-vector/fridge-blue-wall_251819-1328.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="https://image.freepik.com/free-vector/kitchen-interior-smart-fridge-sink-tabletop_107791-2065.jpg" alt="Third slide">
                    </div>
    ...
    <section id="filter" class="featured spad">
        <div class="container">
            ...
            <div class="row">
                    <!-- Portfolio Item 1-->
             <?php 
                      $results = mysqli_query($con,"SELECT * FROM productdetails WHERE product_category='appliances' ORDER BY ID DESC") or die("failed to query database".mysqli_error());
            ...
            <!-- <div class="row featured__filter">
                <div class="col-lg-3 col-md-4 col-sm-6 mix home appliances">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
Induction Cooktop | Very useful when you are new in a city | 6-8 preset cooking menus | Energy saving, quick & efficient heatin</a></h6>
                            <h5> 249/mo </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix home appliances">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/appliances/2.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
                            Semi Automatic Washing Machine | Capacity/Size : 6 Kg
Whirlpool/Haier/Godrej/Samsung/Panasonic | 
Smart Scrub Station</a></h6>
                            <h5> 549/mo </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix home appliances">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/appliances/3.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
                            Air Cooler 35 L| Capacity/Size : 35 L
For rooms up to 50 m3/ 1750 ft3
Consumes 170 watts</a></h6>
                            <h5> 249/mo </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix home appliances">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/appliances/4.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
                            Microwave Solo 20L | Capacity/Size : 17L-20L | 
Brand: Samsung/Bajaj/Whirlpool/Haier/LG | 
Used for Heating, Defrosting & Basic Cooking.</a></h6>
                            <h5> 249/mo </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix home appliances">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/appliances/5.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
                            IFB Dishwasher | Capacity/Size : 12 place | Power - 1900 W | 5 Wash Programs</a></h6>
                            <h5> 249/mo </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix home appliances">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/appliances/6.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
                            Top Load Washing Machine | Capacity/Size : 5.8 to 6.5 | 
Brands: Whirlpool/Haier/Godrej/Samsung
Sleek, compact design</a></h6>
                            <h5> 249/mo </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix home appliances">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/appliances/7.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
                            Mini Fridge | Capacity/Size : 52 L | Brand: Haier | Chiller Compartment: No | Number of Shelves: 1</a></h6>
                            <h5> 249/mo </h5>
                        </div>
                    </div>
                </div>
