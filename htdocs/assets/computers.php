            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="https://image.freepik.com/free-psd/close-up-woman-holding-laptop_23-2148582972.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="https://image.freepik.com/free-psd/macbook-pro-clay-mockup_103373-261.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="https://image.freepik.com/free-psd/smiley-woman-holding-laptop-sofa_23-2148726585.jpg" alt="Third slide">
                    </div>
    ...
    <section id="filter" class="featured spad">
        <div class="container">
            ...
            <div class="row">
                    <!-- Portfolio Item 1-->
             <?php 
                        $results = mysqli_query($con,"SELECT * FROM productdetails WHERE product_category='computers' ORDER BY ID DESC") or die("failed to query database".mysqli_error());
            ...
            <!-- <div class="row featured__filter">
                <div class="col-lg-3 col-md-4 col-sm-6 mix Electronics Computers">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/computers/1.jpg">
                            <ul class="featured__item__pic__hover">
                        ...
                        <div class="featured__item__text">
                            ...
                            Dell Vostro 3490, Intel Core i3 processor , 10th Gen - (8 GB / 1 GB HDD / Win 10 Home , 14 inch, Black)</a></h6>
                            <h5> 1749/mo </h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix Computers Electronics">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/computers/3.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">Lenovo IdeaPad 3, Intel Core i5 processor, 10th Gen - (8GB / 1TB HDD / Win 10 Home, 15.6 inch, Platinum Grey)</a></h6>
                            <h5> 1849/mo</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix Computers Electronics">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/computers/4.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">MacBook Air Intel Core i5 processor , 5th Gen - ( 8 GB / 128 GB SSD / Mac High Sierra OS , 13.3 inch, Silver )</a></h6>
                            <h5> 4999/mo</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix Computers Electronics">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/computers/5.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">Lenovo IdeaPad S340, Intel Core i3 processor, 10th Gen - (8GB / 1TB HDD / Win 10 Home, 14 inch, Platinum Grey)</a></h6>
                            <h5> 4999/mo</h5>
                        </div>
                    </div>
                </div>
