...
<head>
    ...
    <title>Rentweb | Contact Us</title>
...
<body>
  ...
  <div class="humberger__menu__wrapper">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Phone</h4>
                        <a class="contact_uss" href="tel:+91 8769506494">CALL NOW</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Address</h4>
                        <p>Poornima Institute Of Engineering and Technology,<br>ISI-2,RIICO Institutional Area, Gonar Road, Sitapura,<br>Jaipur-302022</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Email</h4>
                        <a class="contact_uss" href="mailto: rentwebhost@gmail.com">rentwebhost@gmail.com</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Map Begin -->
    <div class="map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3562.241682254075!2d75.84852641489488!3d26.76856498318986!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396dc91e898380fd%3A0xeee859ae1f1b64b0!2sPoornima%20Institute%20of%20Engineering%20and%20Technology!5e0!3m2!1sen!2sin!4v1606810619647!5m2!1sen!2sin" height="500" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
    </div>
    <!-- Map End -->
    ...
    <div class="contact-form spad">
        <div class="container">
            ...
            <form id="contactForm" name="sentMessage" action="sendmail.php" method="post">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <input id="name" name="name" type="text" placeholder="Your name " data-validation-required-message="Please enter your name." pattern="[A-Z a-z]{1,32}" title="Must contain alphabatic characters." required />
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <input id="email" name="email" type="email" placeholder="Your Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" title="Must contain @ and at least 2 or more characters like .co, .in, .com, etc." required="required" data-validation-required-message="Please enter your email address." required />
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <input  id="phone" name="phone" type="tel"  placeholder="Your PhoneNumber" pattern="[0-9]{10}"  placeholder="Phone Number" title="Phone Number should be of 10 digits" required="required" data-validation-required-message="Please enter your phone number." />
                                    <p class="help-block text-danger">
                    </div>
                    <div class="col-lg-12 text-center">
                        <textarea name="message" placeholder="Your message" id="message" required="required" data-validation-required-message="Please enter a message."></textarea>
