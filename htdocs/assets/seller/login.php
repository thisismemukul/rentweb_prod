...
<head>
    ...
    <title>Login Become a Seller ||Rentweb</title>
        <!-- Favicon-->
...
<!--===============================================================================================-->
    ...
    <body id="page-top">
        <!--LOGO-->
        <div class="logo">
            <a href="../../home.php"><span class="logo-txt">RENTWEB </span></a>
        </div>
        ...
        <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
            <form class="login100-form validate-form" action="user.php" method="post" >
                ...
                <div class="wrap-input100 validate-input m-b-20" data-validate="Enter username">
                    <input class="input100" type="text" name="username" pattern="^[a-z\d._]{3,}$" title="Must contain at least 3 or more alphabatic or numeric characters,Capital letters not acceptable." placeholder="username">
