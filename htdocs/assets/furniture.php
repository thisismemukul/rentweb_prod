            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="https://image.freepik.com/free-photo/wardrobe-wooden-design-cabinet-tv-wooden-japanese-design-room-minimal-interior_43151-2164.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="https://image.freepik.com/free-photo/closeup-modern-white-table-with-drawer-lights_181624-22994.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="https://image.freepik.com/free-photo/3d-rendering-modern-black-kitchen-with-wood-built_105762-527.jpg" alt="Third slide">
                    </div>
    ...
    <section id="filter" class="featured spad">
        <div class="container">
            ...
            <div class="row">
                    <!-- Portfolio Item 1-->
             <?php 
                        $results = mysqli_query($con,"SELECT * FROM productdetails WHERE product_category='furniture' ORDER BY ID DESC") or die("failed to query database".mysqli_error());
            ...
            <!-- <div class="row featured__filter">
                <div class="col-lg-3 col-md-4 col-sm-6 mix furniture">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/furniture/1.jpg">
                            <ul class="featured__item__pic__hover">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
                            Michelle 4-Seater Dining Set| Dimensions
                                46"L x 30.5"B x 30"H| Wood finish: Pecan brown</a></h6>
                            <h5> 1299/mo </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix furniture">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/furniture/2.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
                            Downey Bar Unit | Storage: 8 + 4 bottle grid | Wood/Finish: Antique cherry</a></h6>
                            <h5> 599/mo </h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix furniture">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/furniture/5.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
                            Casper L-Shaped Sofa | Fully upholstered couch |
                            Soft foam cushioning | Added pouf that serves as extender | 3 Seater:L x B x H:82" x 30" x 32"</a></h6>
                            <h5> 1099/mo </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix furniture">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/furniture/6.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
                            Oliver 2-Seater Sofa | Dimensions
                            46"L x 30"B x 24"H| Wooden Frame Two seat cushions</a></h6>
                            <h5> 899/mo </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix furniture">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/furniture/7.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
                            Pixar TV Unit | Dimensions
                            46"L x 16"B x 24"H |3 shelf + 2 cabinet configuration | Wenge finish</a></h6>
                            <h5> 399/mo </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix furniture">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/furniture/8.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
                            Baby Cot Crib with Mattress | Dimensions
                                49"L x 30.5"B x 30"H| Mattress type: Foam | Recommended age: 0-24 Months | Recommended Mattress size : 60x120x7cm</a></h6>
                            <h5> 1299/mo </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix furniture">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/furniture/9.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
                            Single (6x3) Foam Mattress | Dimensions
                            72"L x 36"B x 4"H | Foam filling for support</a></h6>
                            <h5> 499/mo </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix furniture">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../img/furniture/10.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#">
                            Rowling Bookshelf Divider (L) | Dimensions 35"L x 18"B x 66"H | Shelves: 4 upper, 2 bottom
Storage cabinets: 2</a></h6>
                            <h5> 499/mo </h5>
                        </div>
                    </div>
                </div>
