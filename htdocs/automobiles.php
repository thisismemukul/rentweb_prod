...
<head>
    ...
    <title>Automobiles | Rentweb</title>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="https://image.freepik.com/free-photo/red-luxury-sedan-road_114579-5079.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="https://image.freepik.com/free-photo/motorcycle-studio_37416-146.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="https://image.freepik.com/free-photo/muscular-car-service-worker-repairing-vehicle_146671-19603.jpg" alt="Third slide">
                    </div>
    ...
    <section id="filter" class="featured spad">
        <div class="container">
            ...
            <div class="row featured__filter">
                <div class="col-lg-3 col-md-4 col-sm-6 mix home automobiles">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/automobiles/1.jpg">
...
Induction Cooktop | Very useful when you are new in a city | 6-8 preset cooking menus | Energy saving, quick & efficient heatin</a></h6>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix home automobiles">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/automobiles/2.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
...
Smart Scrub Station</a></h6>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix home automobiles">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/automobiles/3.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
...
Consumes 170 watts</a></h6>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix home automobiles">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/automobiles/4.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
...
Used for Heating, Defrosting & Basic Cooking.</a></h6>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix home automobiles">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/automobiles/5.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix home automobiles">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/automobiles/6.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
...
Sleek, compact design</a></h6>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix home automobiles">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/automobiles/7.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
