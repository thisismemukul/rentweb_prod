...
<head>
    ...
    <title>Office Needs | Rentweb</title>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                     ...
                     <div class="carousel-item active">
                        <img class="d-block w-100" src="https://image.freepik.com/free-vector/abstract-sale-banner-template_23-2148755463.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="https://image.freepik.com/free-vector/sales-best-deal-banner-origami-style-with-ribbons_23-2148417074.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="https://image.freepik.com/free-vector/black-friday-banners-flat-design_23-2148669398.jpg" alt="Third slide">
                    </div>
 ...
 <!-- Featured Section Begin -->
    <section id="filter" class="featured spad">
        <div class="container">
            ...
            <div class="row featured__filter" id='blur'>
                <div class="col-lg-3 col-md-4 col-sm-6 mix Electronics Computers">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/offers/1.jpg">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix Electronics Smartphones">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/offers/2.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix Computers Electronics">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/offers/3.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix Computers Electronics">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/offers/4.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix Electronics">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/offers/6.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix Computers Electronics">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/offers/5.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix Furniture">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/offers/7.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix Furniture">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/offers/8.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix Furniture">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/offers/11.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix Smartphones Electronics">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/offers/12.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix Smartphones Electronics">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="img/offers/10.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="signin.php"><i class="fa fa-heart"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="signin.php"><i class="fa fa-shopping-cart"></i></a></li>
